@executive_create_service_area_page
Feature: Validate executive create service area page functionality
 

 @Smoke
  Scenario:  Validate that elemets is present with executive create service area page
  Given Verify that executive user is on lookups create service area page as expected page title is "Shield"
  ...
  Then Verify that user field place holder value should be "Search your area of service" in the executive create service area page
