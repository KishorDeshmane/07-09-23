@executive_service_area_management_page
Feature: Validate executive service area management page functionality
 
 
 @Smoke
  Scenario:  Validate that elemets is present with executive user in executive service area management page
  Given Verify that executive user is on lookups service area management page as expected page title is "Shield"
  ...
  Then Verify that service area management title text is displayed in the executive service area management page
 	...
 	Then Verify that record per page dropdown list should be 5 in the executive service area management page
  ...
  Then Verify that search user fied placeholder value should be "Search by area, city, emirates or po box..." in the executive service area management page
