@executive_create_attributes_management_page
Feature: Validate executive create attributes management page functionality

  @Smoke
  Scenario: Validate that elements is present with executive create attributes management page
    Given Verify that executive user is on lookups create attributes management page as expected page title is "Shield"
    ...
    Then Verify that attributes name placeholder value should be "Enter attribute name" in the executive create attributes management page
    ...
    Then Verify that attribute value placeholder value should be "Enter attribute value" in the executive create attributes management page
