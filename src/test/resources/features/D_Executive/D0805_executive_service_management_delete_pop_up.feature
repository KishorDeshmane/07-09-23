@executive_services_management_delete_pop_up
Feature: Validate executive services management delete pop up functionality

  @Smoke
  Scenario: Validate that elements is present with executive services management delete pop up
    Given Verify that executive user is on lookups services management delete pop up as expected page title is "Shield"
