@executive_attributes_management_delete_pop_up
Feature: Validate executive attributes management delete pop up functionality

  @Smoke
  Scenario: Validate that elements is present with executive attributes management delete pop up
    Given Verify that executive user is on lookups attributes management delete pop up page as expected page title is "Shield"
