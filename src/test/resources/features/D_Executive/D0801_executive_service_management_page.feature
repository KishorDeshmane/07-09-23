@executive_services_management_page
Feature: Validate executive services management page functionality

  @Smoke
  
  Scenario: Validate that elements is present with executive services management page
    Given Verify that executive user is on lookups services management page as expected page title is "Shield"
    ...
    Then Verify that record per page dropdown count is 5 in the executive services management page
    ...
    Then Verify that search user field place holder value should be "Search by name or category..." in the executive services management page
