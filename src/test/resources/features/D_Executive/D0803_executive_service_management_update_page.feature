@executive_services_management_update_page
Feature: Validate executive update services management page functionality

  @Smoke
  Scenario: Validate that elemets is present with executive services management update page
    Given Verify that executive user is on lookups services management update page as expected page title is "Shield"
    ...
    Then Verify that service name user field placeholder value should be "Enter service name" in the executive update services management page
    ...
    Then Verify that short description user field placeholder value should be "Enter short description" in the executive update services management page
    ...
    Then Verify that long description user field placeholder value should be "Enter long description" in the executive update services management page
    ...
    Then Verify that inclusion user field placeholder value should be "Enter inclusions" in the executive update services management page
    ...
    Then Verify that exclusion user field placeholder value should be "Enter exclusions" in the executive update services management page
    ...
    Then Verify that uplaod image user field placeholder value should be "Enter your user image URL" in the executive update services management page
