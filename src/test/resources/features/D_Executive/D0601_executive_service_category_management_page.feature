@executive_service_category_management_page
Feature: Validate executive service category management page functionality
 
 @Smoke
  Scenario:  Validate that elemets is present with executive service category management page
  Given Verify that executive user is on lookups service category management page as expected page title is "Shield"
  ...
  Then Verify that user should serach userfield placeholder value "Search by name..." from executive service category management page
