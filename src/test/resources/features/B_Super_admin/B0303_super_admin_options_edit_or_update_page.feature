...
Feature: Validate super admin all user action options edit or update user page functionality
  ...
  @Smoke
  Scenario: Validate that elements are presents with Super admin edit or update action options page
    ...
    Then Verify that first name users field placeholder value should be  "Enter your first name" in the super admin all users actions update page
    ...
    Then Verify that last name users field placeholder value should be  "Enter your last name" in the super admin all users actions update page
    ...
    Then Verify that email users field placeholder value should be  "Enter your email address" in the super admin all users actions update page
    ...
    Then Verify that mobile number users field place holder value should be "Enter your mobile number" in the super admin all users actions update page
    ...
    Then Verify that the profile image userfield button placeholder value should be "Enter your user image URL" in super admin all users actions update page
    ...
    Then Verify that assigned roles dropdown place holder value should be "Select roles" in the super admin all users actions update page
