@Super_admin_all_users_option_change_password_page
Feature: Validate super admin all user action options change password functionality


  @Smoke
  Scenario: Validate that elements are presents with Super admin all users action options change password page
    ...
    Then Verify that page current password user field placeholder value should be "Enter your current password" from the super admin all users options change password page
  ...
  Scenario: Validate that elements are presents in Super admin all users action options change password page
    ...
    Then Verify that page new password userfield placeholder value should be "Enter your new password" in the change password second page from super admin all users options change password page
    ...
    Then Verify that page comfirm password userfield placeholder value should be "Confirm your password" in the change password second page from super admin all users options change password page
