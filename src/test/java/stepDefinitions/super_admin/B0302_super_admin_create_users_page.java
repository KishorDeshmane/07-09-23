...
public class B0302_super_admin_create_users_page {
	...
	@Then("Verify that first name users field placeholder value should be  {string} in the super admin all users create users page")
	...
	@Then("Verify that last name users field placeholder value should be  {string} in the super admin all users create users page")
	...
	@Then("Verify that email users field placeholder value should be  {string} in the super admin all users create users page")
	...
	@Then("Verify that mobile number users field place holder value should be {string} in the super admin all users create users page")
	...
	@Then("Verify that password userfield placeholder value should be {string} in the super admin all users create users page")
	...
	@Then("Verify that comfirm password userfield place holder value should be  {string} in the super admin all users create users page")
	...
	@Then("Verify that assigned roles dropdown place holder value should be {string} in the super admin all users create users page")
