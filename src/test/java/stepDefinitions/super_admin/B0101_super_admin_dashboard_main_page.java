...
//	}
	...
	@Then("Verify that dashboard button is clickable from the super admin home page")
	...
	@Then("Verify that user button is clickable from the super admin home page")
...
//	}
	...
	@When("user is at the footer and click on the iffort link from the super admin dashboard page {string}")
	...
	@Then("Verify that user should navigate to the new tab as expected page title is {string} from super admin dashboard page")
