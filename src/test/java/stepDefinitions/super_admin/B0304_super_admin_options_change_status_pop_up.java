...
public class B0304_super_admin_options_change_status_pop_up {
	...
	@When("user click on the change status button from the super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up should be displayed in the super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up title change status of the user should be displayed in super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up cross button should be clickable in super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up cross button click as expected pop up is not displayed in super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up switch button should be clickable in the super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up switch button side text should be displayed in the super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up switch button side text active or inactive is displayed in the super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up submit mouse hover is possible in the super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up cancel button mouse hover is possible in the super admin change status all users action options pop up")
	...
	@Then("Verify that the pop up close button should be close the pop up in the super admin change status all users action options pop up")
