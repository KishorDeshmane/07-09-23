...
public class B0202_super_admin_my_profile_change_password_page {
    ...
    @Then("Verify that page current password user field placeholder value should be {string} from the super admin my profile change password page")
    ...
    @Then("Verify that page new password userfield placeholder value should be {string} in the super admin my profile change password second page")
    ...
    @Then("Verify that page comfirm password userfield placeholder value should be {string} in the super admin my profile change password second page")
