...
public class B0203_super_admin_profile_change_password_page {
    ...
    @Then("Verify that page current password user field placeholder value should be {string} from the super admin profile pop up change password page")
    ...
    @Then("Verify that page new password userfield placeholder value should be {string} in the super admin profile pop up change password second page")
    ...
    @Then("Verify that page comfirm password userfield placeholder value should be {string} in the super admin profile pop up change password second page")
