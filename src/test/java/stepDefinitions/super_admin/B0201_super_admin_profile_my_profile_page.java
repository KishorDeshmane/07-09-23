...
public class B0201_super_admin_profile_my_profile_page {
    ...
    @Then("Verify that first name user field place holder value should be {string} from the super admin profie pop up my profile page")
    ...
    @Then("Verify that last name user field place holder value should be {string} from the super admin profie pop up my profile page")
    ...
    @Then("Verify that user name user field place holder value should be {string} from the super admin profie pop up my profile page")
    ...
    @Then("Verify that email user field place holder value should be {string} from the super admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number country code user field place holder value should be {string} from the super admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number user field placeholder value should be {string} from the super admin profie pop up my profile page")
    ...
    @Then("Verify that profile image user field place holder value should be {string} from the super admin profie pop up my profile page")
