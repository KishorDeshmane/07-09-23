...
public class D0306_executive_options_change_password_page {
	...
	Logger logger = LogManager.getLogger(D0306_executive_options_change_password_page.class);
	...
	@Given("Verify that executive user is on the users all users actions options change password page as expected page title {string}")
	public void verify_that_executive_user_is_on_the_users_all_users_actions_options_change_password_page_as_expected_page_title(String title) {
    ...
    public void verify_that_page_header_change_password_title_text_is_displayed_from_executive_dashboard_options_change_password_page() {
    ...
    public void verify_that_page_breadcrum_list_should_be_displayed_from_the_executive_dashboard_change_password_page() {
    ...
    public void verify_that_page_breadcrum_dashborad_button_should_be_clickable_from_the_executive_dashboard_change_password_page() {
    ...
    public void verify_that_page_breadcrum_change_password_text_is_displayed_from_the_executive_dashboard_change_password_page() {
    ...
    public void verify_that_page_current_password_title_text_above_userfield_should_be_displayed_from_the_executive_change_password_page() {
    ...
    public void verify_that_page_current_password_user_field_should_be_clickable_from_the_executive_change_password_page() {
    ...
    @Then("Verify that page current password user field placeholder value should be {string} from the executive all users options change password page")
    public void verify_that_page_current_password_user_field_placeholder_value_should_be_from_the_executive_change_password_page(String string) {
    ...
    public void verify_that_page_submit_button_should_be_displayed_from_the_executive_change_password_page() {
    ...
    public void verify_that_page_submit_button_should_be_clickable_from_the_executive_change_password_page() {
    ...
    public void verify_that_page_cancel_button_should_be_displayed_from_the_executive_change_password_page() {
    ...
    public void verify_that_page_cancel_button_should_be_clickable_from_the_executive_change_password_page() {
    ...
    public void verify_that_page_submit_button_should_be_able_to_mouse_hover_from_executive_change_password_page() {
    ...
    public void verify_that_page_cancel_button_should_be_able_to_mouse_hover_from_executive_change_password_page() {
    ...
    public void verify_that_page_new_password_title_text_is_displayed_in_the_change_password_second_page_from_executive_change_password_page() {
    ...
    public void verify_that_page_new_password_userfield_should_be_clickable_in_the_change_password_second_page_from_executive_change_password_page() {
    ...
    public void verify_that_page_comfirm_password_title_text_is_displayed_in_the_change_password_second_page_from_executive_change_password_page() {
    ...
    @Then("Verify that page new password userfield placeholder value should be {string} in the change password second page from executive all users options change password page")
    public void verify_that_page_new_password_userfield_placeholder_value_should_be_in_the_change_password_second_page_from_executive_change_password_page(String string) {
    ...
    @Then("Verify that page comfirm password userfield placeholder value should be {string} in the change password second page from executive all users options change password page")
    public void verify_that_page_comfirm_password_userfield_placeholder_value_should_be_in_the_change_password_second_page_from_executive_change_password_page(String string) {
    ...
    public void verify_that_page_comfirm_password_userfield_should_be_clickable_in_the_change_password_second_page_from_executive_change_password_page() {
    ...
    public void verify_that_page_submit_button_should_be_displayed_from_the_executive_change_password_second_page() {
    	boolean actual=sapcp.user_change_password_page_submit_button_is_displayed();
        Assert.assertEquals(actual, true);
 		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
 		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
    ...
    public void verify_that_page_submit_button_should_be_clickable_from_the_executive_change_password_second_page() {
    	boolean actual=sapcp.user_change_password_page_submit_button_is_clickable();
        Assert.assertEquals(actual, true);
 		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
 		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
    ...
    public void verify_that_page_cancel_button_should_be_displayed_from_the_executive_change_password_second_page() {
    	boolean actual=sapcp.user_change_password_page_cancel_button_is_displayed();
        Assert.assertEquals(actual, true);
 		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
 		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
    ...
    public void verify_that_page_cancel_button_should_be_clickable_from_the_executive_change_password_second_page() {
    	boolean actual=sapcp.user_change_password_page_cancel_button_is_clickable();
        Assert.assertEquals(actual, true);
 		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
 		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
    ...
    public void verify_that_page_submit_button_should_be_able_to_mouse_hover_from_executive_change_password_secon_page() {
    	boolean actual=sapcp.user_change_password_page_submit_button_should_be_able_to_mouse_hover();
        Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
    ...
    public void verify_that_page_cancel_button_should_be_able_to_mouse_hover_from_executive_change_password_second_page() {
    	boolean actual=sapcp.user_change_password_page_cancel_button_should_be_able_to_mouse_hover();
        Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
